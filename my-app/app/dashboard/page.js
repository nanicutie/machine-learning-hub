      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand-title {
          ...
          color: #f3e8ff; letter-spacing: 0.02em; line-height: 1;
        }

        .brand-title em {
          font-style: italic; color: rgba(196,181,253,0.7); font-size: 22px;
        }
        ...
        .nav-welcome { font-size: 13px; font-weight: 300; color: rgba(196,181,253,0.45); }

        .nav-profile-btn {
          display: inline-flex; align-items: center; gap: 7px;
          font-family: 'DM Sans', sans-serif;
          font-size: 13px; font-weight: 500;
          color: rgba(196,181,253,0.8); text-decoration: none;
          padding: 7px 14px;
          border: 1px solid rgba(168,85,247,0.25); border-radius: 8px;
          background: rgba(168,85,247,0.08); transition: all 0.2s;
        }

        .nav-profile-btn:hover {
          background: rgba(168,85,247,0.18); border-color: rgba(168,85,247,0.5); color: #d8b4fe;
        }

        .nav-logout-btn {
          font-family: 'DM Sans', sans-serif;
          font-size: 13px; font-weight: 400;
          color: rgba(196,181,253,0.4); background: none; border: none;
        ...
        .publish-toggle-btn {
          ...
          box-shadow: 0 4px 20px rgba(147,51,234,0.4), inset 0 1px 0 rgba(255,255,255,0.1);
          transition: transform 0.15s, box-shadow 0.15s;
        }

        .publish-toggle-btn:hover { transform: translateY(-1px); box-shadow: 0 6px 28px rgba(147,51,234,0.55); }

        .publish-toggle-btn.cancel {
          background: rgba(168,85,247,0.12); border: 1px solid rgba(168,85,247,0.25);
          color: rgba(196,181,253,0.7); box-shadow: none;
        }
        ...
        .publish-form {
          ...
          box-shadow: 0 8px 40px rgba(88,28,135,0.25);
          display: flex; flex-direction: column; gap: 14px;
        }

        .form-label {
          font-size: 11px; font-weight: 500; letter-spacing: 0.14em; text-transform: uppercase;
          color: rgba(196,181,253,0.55); margin-bottom: 6px; display: block;
        }

        .form-input, .form-textarea {
          width: 100%; padding: 11px 15px;
          background: rgba(88,28,135,0.15); border: 1px solid rgba(168,85,247,0.2);
        ...
        .form-input:focus, .form-textarea:focus {
          border-color: rgba(168,85,247,0.55); background: rgba(88,28,135,0.25);
          box-shadow: 0 0 0 3px rgba(168,85,247,0.1);
        }

        .file-zone {
          border: 1px dashed rgba(168,85,247,0.3); border-radius: 10px; padding: 16px;
          text-align: center; background: rgba(88,28,135,0.08);
        ...
        .remove-file-btn {
          ...
          color: rgba(248,113,113,0.7); cursor: pointer; font-size: 12px;
        }
        ...
        .submit-btn {
          ...
          cursor: pointer; box-shadow: 0 4px 20px rgba(147,51,234,0.4);
          transition: transform 0.15s, box-shadow 0.15s;
        }
        ...
        .empty-feed {
          font-size: 14px; color: rgba(196,181,253,0.35);
          font-style: italic; text-align: center; padding: 48px 0;
        }
      `}</style>
        ...
        <div className="dash-inner">
          ...
          <nav className="navbar">
            ...
            <div className="nav-right">
              <span className="nav-welcome">{user.email}</span>
              ...
              <div className="file-zone">
                ...
                <label htmlFor="file-upload" className="file-zone-label">
                  ...
                  {selectedFile && (
                    <>
                      {' · '}{selectedFile.name}
                      <button onClick={(e) => { e.preventDefault(); setSelectedFile(null); }} className="remove-file-btn">✕ remove</button>
                    </>
                  )}
                </label>
              </div>
